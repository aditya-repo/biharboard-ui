...
const StudentProfile = () => {
    ...
    const profiledata = [
        ...
        { id: 3, column: "03", name: "Category", value: "General", field: 'category' },
        { id: 4, column: "04", name: "Date Of Birth", value: "1990-01-01", field: 'dob' },
        { id: 5, column: "05", name: "Father", value: "Raj Kumar", field: 'father' },
        { id: 6, column: "06", name: "Mother", value: "Meera Devi", field: 'mother' },
        { id: 7, column: "07", name: "Mobile", value: "1234567890", field: 'mobile' },
        { id: 8, column: "08", name: "Religion", value: "Hindu", field: 'religion' },
      ];
        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-4">
                ...
                <div className="p-4 font-bold shadow rounded-md border bg-gray-100">
                    ...
                    <img src={FormImage1} style={coordinate}/>
                    </div>
                            ...
                            <table className="min-w-full font-normal bg-white shadow-md rounded-lg overflow-hidden">
                                ...
                                <tbody>
                                    {profiledata.map((profile, index) => (
                                        <tr key={profile.id} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"} onDoubleClick={() => handleDoubleClick(profile.field)}>
                                            ...
                                            <EditableTableCell key={profile.id} initialValue={profile.value} />
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-4">
                ...
                {imagePath.map(item => (
                    ...
                    >
                        ...
                        <img src={item.imgSrc} alt={item.name} className="w-full h-auto mb-2" />
                    </div>
                ))}
            </div>
            {selectedImage && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-lg relative h-[70%]">
                        ...
                        <img src={Photo} alt="Selected" className="max-w-full max-h-full w-auto" />
                    </div>
                </div>
            )}
        </div>
